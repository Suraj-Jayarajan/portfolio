<template>
    <div class="header">
        <h2>
            <a href="https://codepen.io/Suraj-PJ/pen/WbxOMqy" target="_blank" rel="noopener noreferrer">SURAJ</a>
        </h2>
        <div class="mid-spot" @click="toggleGold"></div>
        <button class="contact-btn">
            <span class="glow"></span>
            <span class="contact-btn-content">Contact</span>
        </button>
    ...
    <p class="heroP">
        Senior Full-Stack Developer <br /> Laravel · Vue · Nuxt · n8n · AWS
    </p>
    <div class="mountains">
        <div></div>
        <div></div>
    ...
    <div class="content-section">
        ...
        <p class="subt">Engineering with intent</p>
        <h3 class="title">
            Flexible by Design.
            <br /> Scalable by Nature.
        </h3>
        <p class="subp">
            I architect and build systems that adapt — clean backend foundations,
            modern frontends, and cloud infrastructure that won’t limit growth
        </p>
    </div>
</template>
...
onMounted(() => {
    ...
    window.addEventListener('resize', () => onResize(canvas, ctx));
});
